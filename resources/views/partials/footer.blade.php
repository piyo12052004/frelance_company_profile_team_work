        ...
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mt-4 text-light">
                    ...
                    and scalable digital services to help your business grow and succeed.
                </p>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="mt-4 d-flex flex-column short-link">
                    ...
                    <a href="{{ url('/services') }}" class="mb-2 text-white"><i class="fas fa-angle-right text-secondary me-2"></i>Our
                        Services</a>
                    <a href="{{ url('/projects') }}" class="mb-2 text-white"><i class="fas fa-angle-right text-secondary me-2"></i>Our
                        Projects</a>
